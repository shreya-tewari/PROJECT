...
const rolesList = [
  { role: "React Developer", skills: ["React", "Redux", "TypeScript", "Next.js", "Tailwind CSS"], rate: 22 },
  { role: "Node Developer", skills: ["Node.js", "Express", "TypeScript", "MongoDB", "Redis"], rate: 24 },
  { role: "Python Developer", skills: ["Python", "Django", "FastAPI", "PostgreSQL", "Docker"], rate: 25 },
  { role: "Java Spring Boot", skills: ["Java", "Spring Boot", "Microservices", "Hibernate", "PostgreSQL"], rate: 28 },
  { role: ".NET Developer", skills: ["C#", ".NET Core", "Azure", "SQL Server", "Entity Framework"], rate: 25 },
  { role: "Angular Developer", skills: ["Angular", "RxJS", "TypeScript", "HTML5", "SCSS"], rate: 22 },
  { role: "Flutter Developer", skills: ["Flutter", "Dart", "Firebase", "State Management", "REST API"], rate: 24 },
  { role: "Android Developer", skills: ["Kotlin", "Android SDK", "Jetpack Compose", "Coroutines"], rate: 25 },
  { role: "iOS Developer", skills: ["Swift", "SwiftUI", "Combine", "iOS SDK", "CoreData"], rate: 26 },
  { role: "Cloud Engineer", skills: ["AWS", "Azure", "GCP", "Terraform", "CloudFormation"], rate: 28 },
  { role: "Data Engineer", skills: ["Python", "SQL", "BigQuery", "Spark", "Airflow"], rate: 28 },
  { role: "Automation Tester", skills: ["Selenium", "Cypress", "Python", "Appium", "Jenkins"], rate: 18 },
  { role: "Business Analyst", skills: ["BRD Generation", "UML", "Jira", "User Stories", "SQL"], rate: 22 },
  { role: "Solution Architect", skills: ["System Architecture", "AWS", "Microservices", "Security"], rate: 35 }
];
